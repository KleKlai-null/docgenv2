            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <div class="container"> 
                        ...
                        <form class="col-md-3 input-group" action="{{url('/search-slip')}}">
                          {{-- @csrf --}}
                            ...
                            <tbody>
                              @forelse ($data as $key => $value)
                                <tr>
                                  ...
                                  <td>
                                    <p class="text-muted mb-0">{{ $value->customer_name }}</p>
                                  </td>
                                  <td>
                                  ...
                                  <td>
                                      <p class="text-muted mb-0">{{ $value->released_by }}</p>
                                  </td>
                                  <td>
                                    <a href="{{ route('slip.view', $value->id) }}" target="_blank" class="btn btn-link btn-rounded btn-sm fw-bold">Details</a>
