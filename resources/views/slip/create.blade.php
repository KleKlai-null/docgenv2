    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="card">
                    <form method="POST" action="{{ route('slip.save') }}">
                        @csrf
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-floating mb-3">
                                        <input name="customer_name" type="text" class="form-control" value="{{ old('customer_name') }}" placeholder="Customer Name" autocomplete="off">
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-floating mb-3">
                                        <input name="pallet_no" type="text" value="{{ old('pallet_no') }}" class="form-control" placeholder="Pallet Number" autocomplete="off">
                                        <label for="floatingInput">Pallet Number</label>
                                    </div> 
                                </div>
                                <div class="col">
                                    <div class="form-floating mb-3">
                                        <input name="wh_location" type="text" value="{{ old('wh_location') }}" class="form-control" id="floatingInput" placeholder="Customer Name">
                                        <label for="floatingInput">Warehouse Location</label>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="form-floating mb-3">
                                        <input name="warehouse" type="text" value="{{ old('warehouse') }}" class="form-control" id="floatingInput" placeholder="Customer Name">
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-floating mb-3">
                                        <input name="profit_center" type="text" value="{{ old('profit_center') }}" class="form-control" placeholder="Pallet Number" autocomplete="off">
                                        <label for="floatingInput">Profit Center</label>
                                    </div> 
                                </div>
                                <div class="col">
                                    <div class="form-floating mb-3">
                                        <input name="sub_profit_center" type="text" value="{{ old('sub_profit_center') }}" class="form-control" id="floatingInput" placeholder="Customer Name">
                                        <label for="floatingInput">Sub-Profit Center</label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    <div class="form-floating mb-3">
                                        <input name="released_by" type="text" value="{{ old('released_by') }}" class="form-control" autocomplete="off">
