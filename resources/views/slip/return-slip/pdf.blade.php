	...
	<div id="page-wrap">
        ...
        <table id="meta">
            <tr>
                ...
                <td class="borderless"><div ><p>{{ $returnSlip->document_series_no }} </p></div></td>
            </tr>
            <tr>

                <td class="borderless"><h6>Department</h6></td>
                <td class="borderless"><div><p class="sub">{{ $returnSlip->department }}</p></div></td>
            </tr>
            <tr>
                <td class="borderless"><h6>Date</h6></td>
                <td class="borderless"><div><p class="sub">{{ $returnSlip->created_at->format('d M Y') }}</p></div></td>
            </tr>
            <tr>
                <td class="borderless"><h6>MR Number</h6></td>
                <td class="borderless"><div><p class="sub">{{ $returnSlip->mr_no }}</p></div></td>
            </tr>
            <tr>
                <td class="borderless"><h6>Withdrawal Slip No.</h6></td>
                <td class="borderless"><div><p class="sub">{{ $returnSlip->withdrawal_slip_no }}</p></div></td>
            </tr>
        </table>

		<div id="identity">
            <div id="logo">
                <img src="data:image/png;base64,{{ base64_encode(file_get_contents(public_path('storage/img/qr/return-slip/qr-'.$returnSlip->document_series_no.'.png'))) }}" width="110px">
            </div>
		</div>
		...
		<table id="items">
		  ...
		  <tr class="item-row">
            @forelse ($returnSlip->returnitems as $item)
                <tr>
            ...
            <div style="float: right;">
                <table id="footer">
                    <tr>
                        ...
                        <td class="borderless"><div><p class="sub">{{ $returnSlip->prepared_by }}</p></div></td>
                    </tr>
                    <tr>
                        <td class="borderless"><h6>Aproved by</h6></td>
                        <td class="borderless"><div><p class="sub">{{ $returnSlip->approved_by }}</p></div></td>
                    </tr>
                    <tr>
                        <td class="borderless"><h6>Received by</h6></td>
                        <td class="borderless"><div><p class="sub">{{ $returnSlip->received_by }}</p></div></td>
                    </tr>
                </table>
            </div>
        </div>
